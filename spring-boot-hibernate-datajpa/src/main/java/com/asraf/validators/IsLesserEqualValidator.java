...
public class IsLesserEqualValidator implements ConstraintValidator<IsLesserEqualConstraint, Object> {
	...
	@Override
	public void initialize(IsLesserEqualConstraint constraint) {
